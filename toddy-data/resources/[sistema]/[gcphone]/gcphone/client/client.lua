...
RegisterNUICallback('takePhoto', function(data, cb)
  ...
  while takePhoto do
    ...
    elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
      exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/837155236023238687/GssJzQ-cT8gLD4tDa3yTbsDFY-6Rq-CnuybuLqhGwYoGEPhmRsioKJzrckwEOXOVVKzh", data.field, function(data)
