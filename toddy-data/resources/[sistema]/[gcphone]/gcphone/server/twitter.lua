...
AddEventHandler('gcPhone:twitter_newTweets', function (tweet)
  ...
  local discord_webhook = GetConvar('discord_webhook', 'https://discord.com/api/webhooks/837155236023238687/GssJzQ-cT8gLD4tDa3yTbsDFY-6Rq-CnuybuLqhGwYoGEPhmRsioKJzrckwEOXOVVKzh')
  if discord_webhook == 'https://discord.com/api/webhooks/837155236023238687/GssJzQ-cT8gLD4tDa3yTbsDFY-6Rq-CnuybuLqhGwYoGEPhmRsioKJzrckwEOXOVVKzh' then
    return
  end
  local headers = {
