TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSServer = "drizzle.easyhostoficial.com.br", -- TeamSpeak server address to be displayed on blocking screen
		...
		localNamePrefix = "[ALPHA ACADEMY] ", -- If set, this prefix will be added to the user's teamspeak display name
	}
};
