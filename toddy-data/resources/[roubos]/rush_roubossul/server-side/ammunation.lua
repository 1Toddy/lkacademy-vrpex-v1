...
local armalist = {
	...
	[2] = { ['index'] = "dinheirosujo", ['qtd'] = 50000, ['name'] = "Dinheiro Sujo" },
	[3] = { ['index'] = "dinheirosujo", ['qtd'] = 50000, ['name'] = "Dinheiro Sujo" },
	[4] = { ['index'] = "wbody|WEAPON_PISTOL_MK2", ['qtd'] = 1, ['name'] = "FN FIVE SEVEN" },
	[5] = { ['index'] = "dinheirosujo", ['qtd'] = 50000, ['name'] = "Dinheiro Sujo" },
	[6] = { ['index'] = "wbody|WEAPON_PISTOL_MK2", ['qtd'] = 1, ['name'] = "FN FIVE SEVEN" },
	[7] = { ['index'] = "dinheirosujo", ['qtd'] = 50000, ['name'] = "Dinheiro Sujo" },
	...
	if user_id then
		...
		if #policia >= 2 and not vRPclient.changingClothes(source) then
			if timers == 0 or not timers then
				...
				vRPclient._playAnim(source,false,{{"oddjobs@shop_robbery@rob_till","loop"}},false)
...
function func.giveAward()
	...
	if user_id then
		...
		if randlist >= 90 then
			...
			local randmoney = math.random(50000,50000)
