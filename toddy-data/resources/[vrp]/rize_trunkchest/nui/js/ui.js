...
$(document).ready(function() {
  ...
  document.onkeyup = function(data) {
    if (data.which == 27) {
      $.post("http://rize_trunkchest/invClose", JSON.stringify({}), function(datab) {});
    }
  };
...
const updateMochila = () => {
  ...
  $.post("http://rize_trunkchest/requestMochila", JSON.stringify({}), data => {
