...
vRPN = {}
Tunnel.bindInterface("rize_trunkchest",vRPN)
Proxy.addInterface("rize_trunkchest",vRPN)

vCLIENT = Tunnel.getInterface("rize_garages")

local inventory = module("vrp","cfg/inventory")
-----------------------------------------------------------------------------------------------------------------------------------------
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookbaucarro = "https://discord.com/api/webhooks/798073037567950868/FOxPFlosykGDSSfwDgpTLf2C2rXECxZqdwhaIRMlwQ_o9kFj5Zz9U0fo-U7zqQxptOE7"
