...
$(document).ready(function() {
  ...
  document.onkeyup = function(data) {
    if (data.which == 27) {
      $.post("http://rize_inspect/chestClose", JSON.stringify({}), function(datab) {});
    }
  };
});
...
const updateChest = () => {
  ...
  $.post("http://rize_inspect/requestChest", JSON.stringify({}), data => {
