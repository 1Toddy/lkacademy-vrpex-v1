...
Config.Priority = {
	["steam:11000013f9c7a19"] = 100, -- T O D D Y 
...
Config.Language = {
	joining = "[LK Academy] Entrando...",
	connecting = "[LK Academy] Conectando...",
	err = "[LK Academy] Não foi possível identificar sua Steam ou Social Club.",
	_err = "[LK Academy] Você foi desconectado por demorar demais na fila.",
	pos = "[LK Academy] Você é o %d/%d da fila, aguarde sua conexão",
	connectingerr = "[LK Academy] Não foi possível adiciona-lo na fila.",
    wlonly = "[LK Academy] Você não está aprovado na whitelist.",
	banned = "[LK Academy] Seu passaporte foi revogado na cidade.",
	steam = "[LK Academy] Você precisa estar com a Steam aberta para conectar."
}
