...
local lights = {
    ...
    --VERDES 
    { -183.46,-1615.13,33.76,65,252,3,100.0,1.0 },
    --CRIPS
    { 1285.41,-1730.42,59.16,0,102,255,100.0,1.0 },
    --BLOODS
    { -1077.69,-1661.62,7.42,255,0,0,100.0,0.6 },
    --PRAÇA
    { 178.52,-972.47,33.75,255,255,255,100.0,0.8 },
    { -651.6,-1096.59,58.36,255,255,255,100.0,0.8 },   
}
...
RegisterCommand("attachs",function(source,args)
	local ped = PlayerPedId()
	if src.checarPermissao() or src.CheckComp() then
		if not args[1] then
...
--[ RGB ]----------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("rbgcarfaizen")
AddEventHandler("rbgcarfaizen",function()
        rgbColor()
end)
