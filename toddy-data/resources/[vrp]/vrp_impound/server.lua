        ...
        if vRP.hasPermission(user_id,"mecanico.permissao") then
            ...
            if vehicle then
                if impoundVehs[vname.."-"..placa] then
                    ...
                    TriggerClientEvent("Notify",source,"sucesso","Sucesso","O veículo <b>"..vRP.vehicleName(vname).."</b> foi enviado ao <b>DMV</b> e você recebeu <b>$"..vRP.format(parseInt(randmoney)).." dólares</b>.")
                    return true
                end
            end
        end
        ...
        if vRP.hasPermission(user_id,"policia.permissao") then
            local vehicle,vnetid,placa,vname = vRPclient.vehList(source,7)
             if vehicle then
                ...
                TriggerClientEvent("Notify",source,"sucesso","Sucesso","O veículo <b>"..vRP.vehicleName(vname).."</b> foi cadastrado na lista do <b>DMV</b>.")
             end
        end
    end
end)
