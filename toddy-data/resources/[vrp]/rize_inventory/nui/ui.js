...
$(document).ready(function() {
  ...
  document.onkeyup = function(data) {
    if (data.which == 27) {
      $.post("http://rize_inventory/invClose", JSON.stringify({}), function(datab) {});
    }
  };
});
...
var updateMochila = () => {
  ...
  $.post("http://rize_inventory/requestMochila", JSON.stringify({}), data => {
