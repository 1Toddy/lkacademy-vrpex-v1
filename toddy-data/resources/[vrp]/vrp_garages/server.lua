...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookspawn = "https://discord.com/api/webhooks/788888188353118288/AJWjlAr4tBxsyZTlSET6y_kMq2uboIe8USWiML934BSeW3h6czUEm2TlRc4b9ytKgvXc"
local webhookvehs = "https://discord.com/api/webhooks/798258548966555708/S3KXYUhpOKJjlufeqNM-RqT-Li7cy5VlvNOg3Br3cBlR-ZLgTp_7M_tHXVWc6dmtSn_Q"
local webhookdesmanche = "https://discord.com/api/webhooks/798258706214944798/AJaNgi1MpYQtNLJljmeyEiVyYj1N6izcBotRsBNwoaeHUQcQ5hOFRsTT2KcRja5yQlGg"
...
local garages = {
	...
	[16] = { ['name'] = "Policia", ['payment'] = false, ['perm'] = "dpla.permissao" },
	[17] = { ['name'] = "PoliciaN", ['payment'] = false, ['perm'] = "dpla.permissao" },
	[18] = { ['name'] = "Policia", ['payment'] = false, ['perm'] = "dpla.permissao" },
	[19] = { ['name'] = "Policia", ['payment'] = false, ['perm'] = "dpla.permissao" },
	[20] = { ['name'] = "PoliciaB", ['payment'] = false, ['perm'] = "dpla.permissao" },
	[21] = { ['name'] = "PoliciaH", ['payment'] = false, ['perm'] = "dpla.permissao" },
	[22] = { ['name'] = "PoliciaA", ['payment'] = false, ['perm'] = "dpla.permissao" },	
	...
	[31] = { ['name'] = "Nation", ['payment'] = true, ['perm'] = "livre" },
	[32] = { ['name'] = "Sérvia", ['payment'] = true, ['perm'] = "livre" },
	...
	[62] = { ['name'] = "Policia", ['payment'] = false, ['perm'] = "dpla.permissao" },
	[63] = { ['name'] = "Policia", ['payment'] = false, ['perm'] = "dpla.permissao" },
	[64] = { ['name'] = "Policia", ['payment'] = false, ['perm'] = "dpla.permissao" },
	[65] = { ['name'] = "Policia", ['payment'] = false, ['perm'] = "dpla.permissao" },
	[66] = { ['name'] = "PoliciaB", ['payment'] = false, ['perm'] = "dpla.permissao" },
	[67] = { ['name'] = "PoliciaH", ['payment'] = false, ['perm'] = "dpla.permissao" },
	[68] = { ['name'] = "PoliciaA", ['payment'] = false, ['perm'] = "dpla.permissao" },
					...
					if parseInt(os.time()) <= parseInt(vehicle[1].time+24*60*60) then
						...
						if ok then
							if vRP.tryFullPayment(user_id,parseInt(vRP.vehiclePrice(name)*0.1)) then
								...
								TriggerClientEvent("Notify",source,"negado","Negado","Negado","Dinheiro insuficiente.",10000)
							end
						end
...
RegisterCommand('dv',function(source,args,rawCommand)
	local user_id = vRP.getUserId(source)
	if vRP.hasPermission(user_id,"suporte.permissao") or vRP.hasPermission(user_id,"mecanico.permissao") or vRP.hasPermission(user_id,"conce.permissao") or vRP.hasPermission(user_id,"dpla.permissao") then
...
RegisterCommand('travar',function(source,args,rawCommand)
	...
	local user_id = vRP.getUserId(source)
	if user_id then
		if vRP.hasPermission(user_id,"dpla.permissao") or vRP.hasPermission(user_id,"conce.permissao") then
